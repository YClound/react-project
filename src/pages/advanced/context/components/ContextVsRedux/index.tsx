...
const UserAvatar: ConnectedComponent<any, any> = connect(
  mapStateToProps
)(({ user, size }) => (
  <img
...
const UserStats: ConnectedComponent<any, any> = connect(mapStateToProps)(
  ({ user }) => (
...
class ReduxTest extends Component<any, any> {
  ...
  render() {
    return (
      <Card className="react-base-wrapper" style={{ marginTop: "16px" }}>
        <Nav />
        <Body />
      </Card>
    );
